"""Alembic environment configuration using a synchronous engine."""
...
def _build_alembic_database_url() -> str:
    """Build a synchronous PostgreSQL URL for Alembic only."""
...
def run_migrations_online() -> None:
    """Run migrations in online mode with a synchronous SQLAlchemy engine."""
